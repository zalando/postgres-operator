...
type TopologySpreadConstraint struct {
	MaxSkew            int32    `name:"max_skew" json:"max_skew"`
	TopologyKey        string   `name:"topology_key" json:"topology_key"`
	WhenUnsatisfiable  string   `name:"when_unsatisfiable" json:"when_unsatisfiable"`
	MinDomains         *int32   `name:"min_domains" json:"min_domains,omitempty"`
	NodeAffinityPolicy *string  `name:"node_affinity_policy" json:"node_affinity_policy,omitempty"`
	NodeTaintsPolicy   *string  `name:"node_taints_policy" json:"node_taints_policy,omitempty"`
	MatchLabelKeys     []string `name:"match_label_keys" json:"match_label_keys,omitempty"`
}
...
type Config struct {
	...
	EnableTopologySpreadConstraints          bool                        `name:"enable_topology_spread_constraints" default:"false"`
	TopologySpreadConstraints                []*TopologySpreadConstraint `name:"topology_spread_constraints"`
}
